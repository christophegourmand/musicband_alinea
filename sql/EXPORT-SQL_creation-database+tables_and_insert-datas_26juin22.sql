...
CREATE DATABASE IF NOT EXISTS `db_alinea` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */;
USE `db_alinea`;
...
-- Listage de la structure de la table db_alinea. bio
...
CREATE TABLE IF NOT EXISTS `bio` (
  ...
  `path_image` varchar(512) COLLATE utf8_unicode_ci DEFAULT NULL,
  `description` mediumtext COLLATE utf8_unicode_ci,
  `job` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`rowid`),
  UNIQUE KEY `idx_bio_rowid` (`rowid`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Listage des données de la table db_alinea.bio : ~8 rows (environ)
/*!40000 ALTER TABLE `bio` DISABLE KEYS */;
INSERT INTO `bio` (`rowid`, `active`, `firstname`, `lastname`, `path_image`, `description`, `job`) VALUES
	(1, 1, 'Le Groupe', '', '', 'Formation du groupe Alinéa: été 2019', ''),
	(2, 1, 'Thierry', 'Cividino', '/assets/img/photos/musicians/photo_presentation_thierry2.jpg', 'Oh! Comme nous aimons parler de nous!\r\nIsérois d’origine, né le 21 Novembre 1979.\r\nUne chouette année, j’imagine.\r\nPère. Et Paire.\r\nDistordu par l’attraction gravitationnel de l’Art.\r\nContaminé par le besoin de manquer et d’être utile.\r\nGravement irrécupérable pour cause d’abus de «Blues ».\r\n\r\nAdepte des Dimanches de procrastination, et du café fumant.', 'Guitare, piano, chants.\r\nAuteur/compositeur/interprète'),
	(3, 1, 'Nico', 'Cividino', '/assets/img/photos/musicians/photo_presentation_nico.jpg', 'Originaire du Nord Isère. Né le 08 Mai 1985 dans les bras de sa bonne étoile.\r\nFrère du compositeur.\r\nNe devant sa place qu’à un pauvre concours de circonstances: être venu au monde dans une famille de musiciens.\r\nToujours dispo, maître du tempo, maître du tant pis, pour le meilleur, et surtout, pour le pire.', 'Batteur/Percussionniste'),
	(4, 0, 'Ron Ron', 'Hu Gon', '/assets/img/photos/musicians/photo_presentation_romain.jpg', ' ', 'Bassiste'),
	(5, 1, 'Nicky', 'Rafidinanahary', '/assets/img/photos/musicians/photo_presentation_nicole.jpg', 'Originaire de Lyon. Née un soir de 21 Juillet 1978, de parents choristes Malgaches.\r\nMère d’une lutine, et d’un lutin. Carnassière de littérature, de café chaud et d’esprit curieux à la connaissance.\r\nSes passions musicales n’ont, pour frontière, que l’amitié, la positivité et la confiance.\r\nTimide, utopiste, optimiste, fragile.\r\nConstruit uniquement avec son coeur et prend de la vie ce qu’elle lui offre, sans jamais demander en retour.\r\nSon Credo? …Carpe diem.', 'Chanteuse/Choriste'),
	(6, 0, 'Simone', 'Candian', '/assets/img/photos/musicians/photo_presentation_simone2.jpg', 'Originaire de Latina, banlieue Romaine.\r\nNé le 23/01/1984\r\nA l’aube d’un froid matin d’après tempête.\r\nHeureux Père d’un petit garçon fabuleux.\r\nMusicien aux multiples influences et à l’esprit rock Inconditionnel.\r\nApporte ses improvisations généreuses sur touches noires et blanches, pour le bonheur d’Alinea.\r\nAime à jouer au chat et à la souris avec le batteur.', 'Pianiste'),
	(7, 1, 'Anthony', 'Plaisir', '/assets/img/photos/musicians/photo_presentation_anthony.jpg', 'Originaire d’Angers, Guitariste électro-acoustique depuis sa plus tendre enfance, ses arpèges et rythmiques font de lui le compagnon idéal d’intégration dans cette belle aventure.\r\nStudio ou Scènes, il s’adapte et maîtrise son instrument.\r\nUn parfait musicien comme on les aime …', 'Guitariste'),
	(8, 1, 'Olivier', 'Berton', '/assets/img/photos/musicians/photo_presentation_olivier.jpg', 'Doyen jusqu’à la première note de clavier. Né en février 1970 quelque part sur Terre. Autodidacte insatiable, sensible au grain de l\'orgue B3, accro aux couleurs chaudes et froides des synthés d\'hier, véritable ado devant un son numérique d\'aujourd\'hui. Il ose et propose pour des proses musicales, intercalaire des partitions écrites, le contre-temps est son tempo.', 'Synthés, Orgues, Soundesign');
...
CREATE TABLE IF NOT EXISTS `concert` (
  ...
  `url_map` varchar(512) COLLATE utf8_unicode_ci DEFAULT NULL,
  `path_image` varchar(512) COLLATE utf8_unicode_ci DEFAULT NULL,
  `description` mediumtext COLLATE utf8_unicode_ci,
  PRIMARY KEY (`rowid`),
...
INSERT INTO `concert` (`rowid`, `active`, `date`, `hour_start`, `hour_end`, `venue_name`, `city_name`, `url_map`, `path_image`, `description`) VALUES
	(1, 1, '2022-04-09', '20:00:00', '22:00:00', 'Les Ursulines', 'Crémieu', 'https://goo.gl/maps/dfiKFMc7ahCrUYkUA', 'assets/img/concerts/2022-04-09_les-ursulines.jpeg', 'Ici apparaîtra un texte d\'accroche du concert. Venez nombreux pour boire de la bonne bière brassée dans ce lieu convivial, tout en assistant au concert que nous vous avons préparé !'),
	(2, 1, '2022-07-02', NULL, NULL, 'Olympia', '', 'https://goo.gl/maps/cfqinme4HVhHzNVk7', NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `music_album` (
  ...
  `path_image` varchar(512) COLLATE utf8_unicode_ci DEFAULT NULL,
  `link_spotify` varchar(512) COLLATE utf8_unicode_ci DEFAULT NULL,
  `link_applemusic` varchar(512) COLLATE utf8_unicode_ci DEFAULT NULL,
  `link_itunes` varchar(512) COLLATE utf8_unicode_ci DEFAULT NULL,
  `link_deezer` varchar(512) COLLATE utf8_unicode_ci DEFAULT NULL,
  `link_amazonmusic` varchar(512) COLLATE utf8_unicode_ci DEFAULT NULL,
  `link_googleplay` varchar(512) COLLATE utf8_unicode_ci DEFAULT NULL,
  `link_tidal` varchar(512) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`rowid`),
...
CREATE TABLE IF NOT EXISTS `music_song` (
  ...
  `name` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `path_image` varchar(512) COLLATE utf8_unicode_ci DEFAULT NULL,
  `path_mp3` varchar(512) COLLATE utf8_unicode_ci DEFAULT NULL,
  `lyrics` mediumtext COLLATE utf8_unicode_ci,
  PRIMARY KEY (`rowid`),
...
-- Listage des données de la table db_alinea.music_song : ~15 rows (environ)
...
CREATE TABLE IF NOT EXISTS `product` (
  ...
  `active` tinyint(1) NOT NULL,
  `name` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `purchase_url` varchar(512) COLLATE utf8_unicode_ci DEFAULT NULL,
...
-- Listage des données de la table db_alinea.product : ~10 rows (environ)
...
CREATE TABLE IF NOT EXISTS `productimage` (
  ...
  `alt_text` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`rowid`),
...
-- Listage des données de la table db_alinea.productimage : ~16 rows (environ)
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `pass_encoded` varchar(128) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `fk_group_rowid` int(4) NOT NULL,
...
-- Listage des données de la table db_alinea.user : ~10 rows (environ)
...
INSERT INTO `user` (`rowid`, `active`, `login`, `pass`, `pass_encoded`, `fk_group_rowid`, `date_creation`, `date_last_connection`, `email`) VALUES
	(1, 1, 'christophe', '0uvreToi!ali', '', 1, '2022-06-12 00:32:54', '2022-06-12 00:32:54', 'christophe.gourmand@gmail.com'),
	(2, 1, 'thierry', 'thierry_guitare', '', 1, '2022-06-12 00:32:54', '2022-06-12 00:32:54', 'alineamusique@gmail.com'),
	(3, 1, 'nini', 'nini_micro', '', 2, '2022-06-12 00:32:54', '2022-06-12 00:32:54', ''),
	(4, 1, 'nico', 'nico_batterie', '', 1, '2022-06-12 00:32:54', '2022-06-12 00:32:54', 'civifrance8@gmail.com'),
	(5, 0, 'ronron', 'ronron_basse', '', 2, '2022-06-12 00:32:54', '2022-06-12 00:32:54', ''),
	(6, 0, 'simone', 'simone_piano', '', 2, '2022-06-12 00:32:54', '2022-06-12 00:32:54', ''),
	(7, 1, 'olivier', 'olivier_clavier', '', 2, '2022-06-12 00:32:54', '2022-06-12 00:32:54', ''),
	(8, 1, 'anthony', 'anthony_guitare', '', 2, '2022-06-12 00:32:54', '2022-06-12 00:32:54', ''),
	(9, 1, 'nico2', 'nicotest', '$2y$10$7BfXBozeCZCI77iq5zY7WuDU2fDTiMMmWcmIkl9mafXcn9zL5qXVW', 1, '2022-06-16 23:29:34', '2022-06-16 23:29:34', 'nico@test.fr'),
	(10, 1, 'albert', 'albert', '$2y$10$3NULdytdFEciHJJdl3FsjeoUAxZrhxE3ZyUTRHWKdFuLwT2FjQN6O', 4, '2022-06-17 16:33:20', '2022-06-17 16:33:20', 'albert@einstein.fr');
