...
// VARIABLES USED TO BUILD PATH-TO-FILES : 
	...
	$page_name = "page_dashboard"; // used to build paths-to-files

// VARIABLES USED IN HEADER :
	$page_title = "ALINEA musique - Tableau de bord de l'abonné";
	$page_description = "Tableau de bord pour les membres d'Alinea.";

// VARIABLES TO ADJUST "common elements" (header, navbar, ...)
	$active_menu_in_navbar = "Tableau de bord";
