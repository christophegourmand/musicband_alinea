...
// VARIABLES USED TO BUILD PATH-TO-FILES :
	$page_name = "page_partenaires"; // used to build paths-to-files


// VARIABLES USED IN HEADER :
	$page_title = "ALINEA musique - Contact";
	$page_description = "Contactez le groupe ou ses partenaires, pour un concert, une prestation, ou tout projet";

// VARIABLES TO ADJUST "common elements" (header, navbar, ...)
	$active_menu_in_navbar = "Partenaires";
?>
