    ...
    <section class="musiciens">
        <div class="musiciens-container">
            ...
            <div class="musiciens-2col">
                ...
                <!-- <img class="musiciens-img" src="<?php # echo('/assets/img/photos/musicians/photo_presentation_groupe.jpg');?>" alt="photo du musicien" title="photo du musicien"> -->
        ...
        <div class="musiciens-container">
            ...
            <div class="musiciens-2col">
                ...
                <img class="musiciens-img" src="<?php echo('/assets/img/photos/musicians/photo_presentation_thierry2.jpg');?>" alt="photo du musicien" title="photo du musicien">
        ...
        <div class="musiciens-container">
            ...
            <div class="musiciens-2col">
                ...
                <img class="musiciens-img" src="<?php echo('/assets/img/photos/musicians/photo_presentation_nico.jpg');?>" alt="photo du musicien" title="photo du musicien">
                <p class="musiciens-description">Originaire du Nord Isère. Né le 08 Mai 1985 dans les bras de sa bonne étoile. <br>
                Frère du compositeur.<br>
        ...
        <div class="musiciens-container">
            ...
            <div class="musiciens-2col">
                ...
                <img class="musiciens-img" src="<?php echo('/assets/img/photos/musicians/photo_presentation_romain.jpg');?>" alt="photo du musicien" title="photo du musicien">
                <p class="musiciens-description">Romain Hugon dit Ronron<br>Né pour l'apéro du 19 février 1986 au Bronx 69.<br>Toujours prêt à faire ronronner son combi pour délirer en musique avec les potes.<br>Force tranquille qui sait se faire entendre avec sa petite voix fluette....<br>"Roots Rock Reggae dis a reggae music"</p>
            </div>
        ...
        <div class="musiciens-container">
            ...
            <div class="musiciens-2col">
                ...
                <img class="musiciens-img" src="<?php echo('/assets/img/photos/musicians/photo_presentation_nicole.jpg');?>" alt="photo du musicien" title="photo du musicien">
        ...
        <div class="musiciens-container">
            ...
            <div class="musiciens-2col">
                <img class="musiciens-img" src="<?php echo('/assets/img/photos/musicians/photo_presentation_simone2.jpg');?>" alt="photo du musicien" title="photo du musicien">
        ...
        <div class="musiciens-container">
            ...
            <div class="musiciens-2col">
                <img class="musiciens-img" src="<?php echo('/assets/img/photos/musicians/photo_presentation_anthony.jpg');?>" alt="photo du musicien" title="photo du musicien">
        ...
        <div class="musiciens-container">
            ...
            <p class="musiciens-role">Claviériste</p>
        </div>
    </section>
</main>