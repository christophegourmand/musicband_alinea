...
<table class="datatable">
	<tr class="datatable-line-titles">
		<?php foreach ($GLOBALS['fieldsOfTableConcert'] as $looping_fieldName): ?>
			<th class="datatable-title"><?= $looping_fieldName ?></th>
		<?php endforeach ?>
	</tr>
</table>
-->
	...
	<div class="formdatabase-container">
		<form method="POST" action="" class="formdatabase">
			...
			<div class="formdatabase-buttons">
				<a href="<?= $_SERVER['PHP_SELF'].'?clicked_menu='.$_GET['clicked_menu'].'&rowidInModifyMode='.$concertRowFromDb['rowid'] ?>" class="btn-fit-outline-orange">Modifier</a>
