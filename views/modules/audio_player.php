<!-- Thanks to Greg Hovanesyan for this player -->
...
<!-- <div class="holder"> -->
    <div class="audio green-audio-player">
        ...
        <audio crossorigin>
            <source src="<?= $song_mp3_source_str ?>" type="audio/mpeg">
        </audio>
    </div>
<!-- </div> -->

<script src="<?=$prefix_to_root_folder.'assets/js/green-audio-player.js' ?>"></script>