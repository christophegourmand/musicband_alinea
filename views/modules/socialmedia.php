<section class="socialMedia">
    ...
    <div class="socialMedia-link-container">
        ...
        <a class="socialMedia-link bg-instagram" href="https://www.instagram.com/alineamusique/" target="_blank">
            <img class="socialMedia-logo" src="<?php echo($prefix_to_root_folder.'/assets/img/partners/instagram/glyph-logo_May2016_modified_white_400px.png');?>" alt="logo plateforme musicale" title="logo plateforme musicale">
        </a>
    </div>
</section>